...
import data from "../../data/Council/be";
    ...
    <div>
      <Tabs>
        <TabList>
          <Tab
            className={`${
              heads && "animate-clickbe"
            } float-left text-slate-200 bg-zinc-900 hover:bg-zinc-700 w-1/5 py-2 mt-8 rounded-l-xl`}
            onClick={() => {
              setHeads(true);
            }}
            onAnimationEnd={() => setHeads(false)}
          >
            Heads
          </Tab>
          <Tab
            className={`${
              tech && "animate-clickbe"
            } float-left text-slate-200 bg-zinc-900 hover:bg-zinc-700 w-1/5 py-2 mt-8`}
            onClick={() => {
              setTech(true);
            }}
            onAnimationEnd={() => setTech(false)}
          >
            Tech
          </Tab>
          <Tab
            ...
            onAnimationEnd={() => setOps(false)}
          >
            Operations
          </Tab>
          <Tab
            className={`${
              graphics && "animate-clickbe"
            } float-left text-slate-200 bg-zinc-900 hover:bg-zinc-700 w-1/5 py-2 mt-8`}
            onClick={() => {
              setGraphics(true);
            }}
            onAnimationEnd={() => setGraphics(false)}
          >
            Graphics
          </Tab>
          <Tab
            className={`${
              graphics && "animate-clickbe"
            } float-left text-slate-200 bg-zinc-900 hover:bg-zinc-700 w-1/5 py-2 mt-8 rounded-r-xl`}
            onClick={() => {
              setGraphics(true);
            }}
            onAnimationEnd={() => setGraphics(false)}
          ...
          <section className="text-zinc-900 bg-gray-200 body-font pt-16">
            ...
            <div className="grid justify-center md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-7 my-10">
              ...
              <Card
                ...
                image={data[6].img}
                insta={data[6].insta}
                linkedin={data[6].linkedin}
                github={data[6].github}
              />
              <Card
                name={data[7].name}
                position={data[7].position}
                image={data[7].img}
                insta={data[7].insta}
                linkedin={data[7].linkedin}
                github={data[7].github}
              />
              <Card
                name={data[8].name}
                position={data[8].position}
                image={data[8].img}
                insta={data[8].insta}
          ...
          <section className="text-zinc-900 bg-gray-200 body-font pt-16">
            <div className="grid justify-center md:grid-cols-3 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
              <Card
                ...
                image={data[11].img}
                insta={data[11].insta}
                linkedin={data[11].linkedin}
                github={data[11].github}
              />
              <Card
                name={data[12].name}
                position={data[12].position}
                image={data[12].img}
                insta={data[12].insta}
          ...
          <section className="text-zinc-900 bg-gray-200 body-font pt-16 mt-8">
            <div className="grid justify-center md:grid-cols-1 lg:grid-cols-1 gap-5 lg:gap-7 my-10">
              <Card
                ...
                image={data[14].img}
                insta={data[14].insta}
                linkedin={data[14].linkedin}
                github={data[14].github}
              />
            </div>
          </section>
        </TabPanel>

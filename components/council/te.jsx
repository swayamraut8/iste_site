                ...
                <TabPanel>
                    <section className="text-zinc-900 bg-gray-200 body-font pt-16 mt-8">
                        ...
                        <div className="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10">
                            ...
                            <Card name={data[8].name} position={data[7].position} image={data[8].img} insta={data[8].insta} linkedin={data[8].linkedin} github={data[8].github} />
                            <Card name={data[9].name} position={data[8].position} image={data[9].img} insta={data[9].insta} linkedin={data[9].linkedin} github={data[9].github} />
                        </div>
                    </section>
                </TabPanel>
                <TabPanel>
